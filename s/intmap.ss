...
(module
 ...
 (define ($intmap-merge key= id f g1 g2 t1 t2)
   (merge/key key= br* id f g1 g2 t1 t2))

 (define (merge/key key= bin id f g1 g2 t1 t2)
   (define-syntax go
     (syntax-rules ()
       [(_ t1 t2) (merge/key key= bin id f g1 g2 t1 t2)]))
